...
if __name__ == "__main__":
    ...
    dataset = {"DC characters":["SUPERMAN", "JOKER", "HARLEY QUINN", "GREEN LANTERN", "FLASH", "WONDER WOMAN", "AQUAMAN", "BATMAN"],
                 "Marvel characters":["CAPTAIN AMERICA", "IRON MAN", "THANOS", "THOR", "BLACK PANTHER", "BLACK WIDOW", "HULK", "DOCTOR STRANGE", "SPIDER MAN"],
                 "Anime characters":["MONKEY D. LUFFY", "RORONOA ZORO", "LIGHT YAGAMI", "MIDORIYA IZUKU", "NARUTO", "ITACHI UCHIHA"]
                 }
